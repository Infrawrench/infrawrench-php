...
Generated PHP client for the Infrawrench API (API version `1.26.0`).
...
This package covers the published API surface only: 488 operations across
676 schemas. Operations marked `x-internal` in the spec — the admin surface,
