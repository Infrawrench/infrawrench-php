...
Generated PHP client for the Infrawrench API (API version `1.10.0`).
...
This package covers the published API surface only: 411 operations across
553 schemas. Operations marked `x-internal` in the spec — the admin surface,
