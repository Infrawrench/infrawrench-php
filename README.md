...
Generated PHP client for the Infrawrench API (API version `1.2.0`).
...
This package covers the published API surface only: 310 operations across
435 schemas. Operations marked `x-internal` in the spec — the admin surface,
