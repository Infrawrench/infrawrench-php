...
Generated PHP client for the Infrawrench API (API version `1.18.0`).
...
This package covers the published API surface only: 446 operations across
615 schemas. Operations marked `x-internal` in the spec — the admin surface,
