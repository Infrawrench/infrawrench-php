...
Generated PHP client for the Infrawrench API (API version `0.7.0`).
...
This package covers the published API surface only: 159 operations across
194 schemas. Operations marked `x-internal` in the spec — the admin surface,
