...
Generated PHP client for the Infrawrench API (API version `1.6.0`).
...
This package covers the published API surface only: 367 operations across
505 schemas. Operations marked `x-internal` in the spec — the admin surface,
