...
Generated PHP client for the Infrawrench API (API version `0.24.0`).
...
This package covers the published API surface only: 196 operations across
243 schemas. Operations marked `x-internal` in the spec — the admin surface,
