...
Generated PHP client for the Infrawrench API (API version `1.9.0`).
...
This package covers the published API surface only: 407 operations across
545 schemas. Operations marked `x-internal` in the spec — the admin surface,
