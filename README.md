...
Generated PHP client for the Infrawrench API (API version `1.21.0`).
...
This package covers the published API surface only: 471 operations across
654 schemas. Operations marked `x-internal` in the spec — the admin surface,
