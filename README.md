...
Generated PHP client for the Infrawrench API (API version `1.33.0`).
...
This package covers the published API surface only: 506 operations across
710 schemas. Operations marked `x-internal` in the spec — the admin surface,
