...
Generated PHP client for the Infrawrench API (API version `1.0.0`).
...
This package covers the published API surface only: 306 operations across
409 schemas. Operations marked `x-internal` in the spec — the admin surface,
