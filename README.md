...
Generated PHP client for the Infrawrench API (API version `0.43.0`).
...
This package covers the published API surface only: 289 operations across
383 schemas. Operations marked `x-internal` in the spec — the admin surface,
