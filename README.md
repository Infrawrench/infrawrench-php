...
Generated PHP client for the Infrawrench API (API version `1.17.0`).
...
This package covers the published API surface only: 443 operations across
601 schemas. Operations marked `x-internal` in the spec — the admin surface,
