...
Generated PHP client for the Infrawrench API (API version `1.13.0`).
...
This package covers the published API surface only: 415 operations across
565 schemas. Operations marked `x-internal` in the spec — the admin surface,
