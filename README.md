...
Generated PHP client for the Infrawrench API (API version `1.12.0`).
...
This package covers the published API surface only: 414 operations across
559 schemas. Operations marked `x-internal` in the spec — the admin surface,
