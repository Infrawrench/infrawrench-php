...
Generated PHP client for the Infrawrench API (API version `1.28.0`).
...
This package covers the published API surface only: 489 operations across
680 schemas. Operations marked `x-internal` in the spec — the admin surface,
