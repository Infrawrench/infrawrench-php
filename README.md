...
Generated PHP client for the Infrawrench API (API version `1.36.0`).
...
This package covers the published API surface only: 522 operations across
729 schemas. Operations marked `x-internal` in the spec — the admin surface,
