...
Generated PHP client for the Infrawrench API (API version `0.25.0`).
...
This package covers the published API surface only: 197 operations across
246 schemas. Operations marked `x-internal` in the spec — the admin surface,
