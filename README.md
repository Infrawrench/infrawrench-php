...
Generated PHP client for the Infrawrench API (API version `0.16.0`).
...
This package covers the published API surface only: 180 operations across
223 schemas. Operations marked `x-internal` in the spec — the admin surface,
