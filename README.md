...
Generated PHP client for the Infrawrench API (API version `1.37.0`).
...
This package covers the published API surface only: 528 operations across
734 schemas. Operations marked `x-internal` in the spec — the admin surface,
