...
Generated PHP client for the Infrawrench API (API version `1.23.0`).
...
This package covers the published API surface only: 472 operations across
655 schemas. Operations marked `x-internal` in the spec — the admin surface,
