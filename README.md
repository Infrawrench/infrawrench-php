...
Generated PHP client for the Infrawrench API (API version `1.34.0`).
...
This package covers the published API surface only: 515 operations across
721 schemas. Operations marked `x-internal` in the spec — the admin surface,
