...
Generated PHP client for the Infrawrench API (API version `1.19.0`).
...
This package covers the published API surface only: 451 operations across
625 schemas. Operations marked `x-internal` in the spec — the admin surface,
