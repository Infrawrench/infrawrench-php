...
Generated PHP client for the Infrawrench API (API version `1.38.0`).
...
This package covers the published API surface only: 525 operations across
731 schemas. Operations marked `x-internal` in the spec — the admin surface,
