...
Generated PHP client for the Infrawrench API (API version `1.35.0`).
...
This package covers the published API surface only: 518 operations across
724 schemas. Operations marked `x-internal` in the spec — the admin surface,
