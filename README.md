...
Generated PHP client for the Infrawrench API (API version `0.44.0`).
...
This package covers the published API surface only: 300 operations across
399 schemas. Operations marked `x-internal` in the spec — the admin surface,
