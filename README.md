...
Generated PHP client for the Infrawrench API (API version `1.1.0`).
...
This package covers the published API surface only: 307 operations across
417 schemas. Operations marked `x-internal` in the spec — the admin surface,
