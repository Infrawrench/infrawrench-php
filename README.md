...
Generated PHP client for the Infrawrench API (API version `1.20.0`).
...
This package covers the published API surface only: 457 operations across
635 schemas. Operations marked `x-internal` in the spec — the admin surface,
