...
Generated PHP client for the Infrawrench API (API version `0.23.0`).
...
This package covers the published API surface only: 195 operations across
242 schemas. Operations marked `x-internal` in the spec — the admin surface,
