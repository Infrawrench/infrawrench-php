...
final class CostAlertsGetNamespace extends ApiNamespace
{
    /**
     ...
     * @throws \Infrawrench\Sdk\MissingParameterException if a path parameter has no value.
     */
    public function getOrgOrgIdCostAlertsId(string $id, ?string $orgId = null, ?RequestOptions $options = null): CostAlert
    {
        $data = $this->transport->request(
            new RequestSpec(
                method: 'GET',
