...
/**
 * Supply a key to test one that has not been saved yet; send an empty object to re-test the stored
 * one.
 */
final class LinearVerifyInput implements \JsonSerializable
{
