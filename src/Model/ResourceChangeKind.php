...
/**
 * What happened between two consecutive syncs: the resource appeared, a stored field changed, or
 * the resource disappeared upstream.
 *
 * The values `ResourceChangeKind` accepts.
 *
 ...
 */
final class ResourceChangeKind
{
