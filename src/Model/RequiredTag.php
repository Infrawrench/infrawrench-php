...
final class RequiredTag implements \JsonSerializable
{
    /**
     * @param list<string>|null $allowedValues When set, the tag's value must be one of these (compared exactly).
     */
