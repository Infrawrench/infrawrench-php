...
final class GeneratedSshKey implements \JsonSerializable
{
    /**
     * @param SshKeyType::* $keyType
     * @param string $privateKey Returned once. Not persisted in plaintext.
     */
    ...
    public static function fromArray(array $data): self
    {
        return new self(
            ...
            privateKey: Coerce::toString($data['privateKey'] ?? null),
        );
    }
