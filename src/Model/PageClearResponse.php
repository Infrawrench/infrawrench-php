...
final class PageClearResponse implements \JsonSerializable
{
    /** @param bool $cleared False when the key had no cooldown to clear. */
    ...
    {
        return new self(
            cleared: Coerce::toBool($data['cleared'] ?? null),
        );
    }
