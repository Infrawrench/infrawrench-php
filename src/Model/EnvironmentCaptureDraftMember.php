...
final class EnvironmentCaptureDraftMember implements \JsonSerializable
{
    /**
     ...
     * @param array<string, array{label: string, kind: string, required: bool, options?: list<array{id: string, label: string}>, parameterisable: bool}> $fieldMeta
    ...
    public static function fromArray(array $data): self
    {
        return new self(
            ...
            fieldMeta: Coerce::mapValues($data['fieldMeta'] ?? null, static fn (mixed $item): array => Coerce::toArray($item)),
