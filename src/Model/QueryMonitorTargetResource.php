...
final class QueryMonitorTargetResource implements \JsonSerializable
{
    /** @param string $typeName The resource type's display name, e.g. 'D1 Database'. */
    ...
    public static function fromArray(array $data): self
    {
        return new self(
            ...
            typeName: Coerce::toString($data['typeName'] ?? null),
        );
    }
