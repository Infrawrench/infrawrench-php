...
final class EditableField implements \JsonSerializable
{
    /**
     * @param 'string'|'number'|'boolean'|'enum'|'secret'|'association'|'password' $kind
    ...
    public static function fromArray(array $data): self
    {
        return new self(
            ...
            enumValues: Coerce::nullable($data['enumValues'] ?? null, static fn (mixed $value): array => Coerce::mapList($value, static fn (mixed $item): string => Coerce::toString($item))),
        );
    }
    ...
    public function toArray(): array
    {
        ...
        if ($this->enumValues !== null) {
            $payload['enumValues'] = $this->enumValues;
        }
