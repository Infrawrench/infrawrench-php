...
final class SshExecResponse implements \JsonSerializable
{
    ...
    public static function fromArray(array $data): self
    {
        return new self(
            ...
            code: Coerce::toInt($data['code'] ?? null),
            stderr: Coerce::toStringOrNull($data['stderr'] ?? null),
        );
    }
