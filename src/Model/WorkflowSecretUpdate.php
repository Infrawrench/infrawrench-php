...
final class WorkflowSecretUpdate implements \JsonSerializable
{
    /**
     * @param string|null $name JavaScript dot identifier used to expose the value to workflow code, for example `API_TOKEN` or `stripe.apiKey`.
     */
