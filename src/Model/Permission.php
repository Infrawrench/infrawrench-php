...
final class Permission
{
    ...
    public const WORKFLOWS_READ = 'workflows:read';
    public const WORKFLOWS_WRITE = 'workflows:write';
    public const WORKFLOWS_APPROVE = 'workflows:approve';
    ...
    public const INCIDENTS_READ = 'incidents:read';
    public const INCIDENTS_WRITE = 'incidents:write';
    ...
    public const IAC_READ = 'iac:read';
    public const IAC_WRITE = 'iac:write';
