...
final class EnvironmentTemplate implements \JsonSerializable
{
    /**
    ...
    public function __construct(
        ...
        public readonly ?int $activeInstanceCount = null,
    ) {
    }
    ...
    public static function fromArray(array $data): self
    {
        return new self(
            ...
            activeInstanceCount: Coerce::toIntOrNull($data['activeInstanceCount'] ?? null),
        );
    }
    ...
    public function toArray(): array
    {
        ...
        if ($this->activeInstanceCount !== null) {
            $payload['activeInstanceCount'] = $this->activeInstanceCount;
        }
