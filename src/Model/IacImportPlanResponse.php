...
final class IacImportPlanResponse implements \JsonSerializable
{
    /**
     * @param string $hcl `import` blocks followed by the generated resource stanzas.
     * @param list<array{resourceId: string, address: string, importId: string|null}> $exported
     * @param list<array{resourceId: string, displayName: string, reason: string}> $unsupported
     */
