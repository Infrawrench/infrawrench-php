...
final class DismissedPostureFinding implements \JsonSerializable
{
    /**
    ...
    public function __construct(
        ...
        public readonly PostureDismissal $dismissal,
    ) {
    }
    ...
    public static function fromArray(array $data): self
    {
        return new self(
            ...
            dismissal: PostureDismissal::fromArray(Coerce::toArray($data['dismissal'] ?? null)),
        );
    }
