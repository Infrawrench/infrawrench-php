...
final class IacImportPlanRequest implements \JsonSerializable
{
    ...
    {
        return new self(
            resourceIds: Coerce::mapList($data['resourceIds'] ?? null, static fn (mixed $item): string => Coerce::toString($item)),
        );
    }
