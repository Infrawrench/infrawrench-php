...
final class DismissedAccessFinding implements \JsonSerializable
{
    /**
    ...
    public function __construct(
        ...
        public readonly AccessReviewDismissal $dismissal,
    ) {
    }
    ...
    public static function fromArray(array $data): self
    {
        return new self(
            ...
            dismissal: AccessReviewDismissal::fromArray(Coerce::toArray($data['dismissal'] ?? null)),
        );
    }
    ...
    public function toArray(): array
    {
        return [
            ...
            'dismissal' => $this->dismissal->toArray(),
        ];
    }
