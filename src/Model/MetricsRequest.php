...
final class MetricsRequest implements \JsonSerializable
{
    public function __construct(
        public readonly string $accountId,
        public readonly string $resourceId,
        public readonly ?int $startMs = null,
        public readonly ?int $endMs = null,
    ...
    public static function fromArray(array $data): self
    {
        return new self(
            ...
            startMs: Coerce::toIntOrNull($data['startMs'] ?? null),
            endMs: Coerce::toIntOrNull($data['endMs'] ?? null),
    ...
    public function toArray(): array
    {
        ...
        if ($this->startMs !== null) {
            $payload['startMs'] = $this->startMs;
        }
        if ($this->endMs !== null) {
            $payload['endMs'] = $this->endMs;
        }
